...
import { handleCategoryDistribution, handleGetAgentPackages, handleGetBookings, handlePopularDestinations, handleRevenue } from "../../redux/reducers/agent/agentReducer";
...
export default function AgentDash() {
  ...
  const packageCount = useSelector((state) => state.agent?.packageCount);
  const bookingCount = useSelector((state) => state.agent?.bookingCount);
  ...
  <div className="w-full max-w-xl ">
    ...
    <Line
      data={{
        labels: revenue?.map(trend => trend?.day),
        datasets: [
          {
            label: 'Revenue',
            data: revenue?.map(trend => trend?.total_revenue),
