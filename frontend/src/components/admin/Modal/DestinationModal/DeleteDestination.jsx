...
const DeleteDestinationModal = ({ isOpen, onConfirm, onClose, destinationIdToDelete,destination }) => {
    console.log("Destination from delete: " + destination)
    return (
      ...
      {destinationIdToDelete && ( // Check if destinationId exists before displaying
        <p className="text-sm text-gray-700">
          Are you sure you want to delete destination: {destination.destination_name}?
        </p>
      )}
    </div>
